...
public class ReservationController {
    ...
    public ResponseEntity<Reservation> createReservation(@RequestBody Reservation reservation) {
        ...
        Optional<UserEntity> userOptional = userRepository.findById(reservation.getUserEntity().getId());
        ...
        reservation.setUserEntity(userOptional.get());
    ...
    public ResponseEntity<Reservation> updateReservation(@PathVariable("id") long id, @RequestBody Reservation updatedReservation) {
        ...
        // Update fields
        Optional<UserEntity> userOptional = userRepository.findById(updatedReservation.getUserEntity().getId());
        if (userOptional.isEmpty()) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).build();
        }
        ...
        existingReservation.setUserEntity(userOptional.get());
